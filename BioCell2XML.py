...
Pennerstorfer M, Loose G, Wolff C (2019). BioCell2XML: A novel tool for converting cell lineage
data from SIMI BioCell to MaMuT (Fiji). Development Genes and Evolution.
...
-m      --mitoses       mode for reconstruction of mitoses (choices: 0, 1, 2, 3)
                        [-m0: no mitosis reconstruction (default)
                         -m1: offspring spots are added at frame of mitosis
                         -m2: parent spots are added one frame before mitosis
                         -m3: offspring spots are added at frame of mitosis and
                              parent spots are added one frame before mitosis]
